...
const Detail = () => {
    ...
    const navigate = useNavigate();  //history molde와 유사
    const historyBack = () => {
        navigate(-1);
    }
            ...
            <div className="detail-cont">
                <div className="wrap">
                    ...
                    <div className="history flex-style-2 gap-20">
                        <Link to={"/category/"+brandIndex}>리스트화면</Link>
                        <Link to="/">메인화면</Link>


                        {/* <button onClick={historyBack}>목록보기</button>
                        <button onClick={historyBack}>메인가기</button> */}
                    </div>
                </div>
